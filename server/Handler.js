...
const sendOtp = (req, res) => {
  ...
  <td>
    <table style="width: 100%; text-align: start; display: flex;">
      ...
      <tr>
        <td style="font-size: 14px; font-weight: bold; color: #333;">TEAM HR</td>
      </tr>
      <tr>
        <td style="font-size: 12px; color: #5e5e5e;">Forwardcode TechStudio</td>
      </tr>
      <tr>
        <td style="font-size: 12px; color: #5e5e5e;">Jamshedpur, JH - 831018</td>
      </tr>
      <tr>
    ...
    <tr>
      <td align="start" style="padding: 1rem;">
        ...
        <p style="font-size: 8px; margin: 0;">PLEASE CONSIDER THE ENVIRONMENT BEFORE PRINTING THIS EMAIL.
          ...
          COMMUNICATION IN ERROR, PLEASE NOTIFY US IMMEDIATELY BY TELEPHONE AND/OR RETURN E-MAIL. THANK YOU</p>
      </td>
    </tr>
  </table>
</body>`,
